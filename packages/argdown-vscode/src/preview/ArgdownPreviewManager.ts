...
{
  private static readonly markdownPreviewActiveContextKey =
  ...
  private readonly _dynamicPreviews = this._register(
    new PreviewStore<DynamicArgdownPreview>()
  );
  private readonly _staticPreviews = this._register(
    new PreviewStore<StaticArgdownPreview>()
  );
  ...
  public constructor(
    ...
    super();
    this._previewConfigurations = new ArgdownPreviewConfigurationManager(
      _engine
    );
    this._register(
  ...
  public async resolveCustomTextEditor(
    ...
    const lineNumber = this._topmostLineMonitor.getPreviousTextEditorLineByUri(
      document.uri
    );
  ...
  private registerStaticPreview(
    preview: StaticArgdownPreview
  ): StaticArgdownPreview {
  ...
  private setPreviewActiveContext(value: boolean) {
    vscode.commands.executeCommand(
      "setContext",
      ArgdownPreviewManager.markdownPreviewActiveContextKey,
      value
    );
  }
}
