...
> {
  ...
  builder: Record<keyof IWebComponentCliOptions, Options> = {
    inputGlob: {
    ...
    removeFrontMatter: {
      ...
      describe:
        "Removes the frontmatter section from the highlighted source code",
      type: "boolean",
      default: false
    },
  ...
  handler = async function (
    ...
    if (args.addWebComponentPolyfill) {
      config.webComponent.addWebComponentPolyfill =
        args.addWebComponentPolyfill;
    }
