import { LabelMode, StatementSelectionMode } from "@argdown/core";
    ...
    CommandModule<IGeneralCliOptions, IMapCliOptions & IGeneralCliOptions>
{
  ...
  builder: Record<keyof IMapCliOptions, Options> = {
    inputGlob: {
  ...
  handler = async (args: Arguments<IGeneralCliOptions & IMapCliOptions>) => {
